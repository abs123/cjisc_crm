...
<div class="container">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading ">Asignar Archivos tipo  <span style="color:red; ">Certificado Sello Digital</span> </div>
				<div class="panel-body">
					<div class="container">					 
					 <div class="row">   
					   <div class="col">
							    <form:form modelAttribute="fileInfo" action="${contextRoot}/files/tipocsd" method="post"  enctype="multipart/form-data" cssClass="form-horizontal" role="form">
